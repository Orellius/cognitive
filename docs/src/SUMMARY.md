...
- [Claude (Anthropic)](./backends/claude.md)
- [OpenAI / Compatible](./backends/openai.md)
- [Ollama (Local)](./backends/ollama.md)

# Recipes

- [Safe Code Execution](./recipes/safe-execution.md)
- [Voice-Matched Responses](./recipes/voice-matching.md)
- [Full Stack Pipeline](./recipes/full-stack.md)
